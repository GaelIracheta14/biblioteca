...
use App\Http\Controllers\HomaController;
...
// Una sola ruta que muestra la vista con login Y registro
...
Route::middleware('auth')->group(function(){
        ...
        Route::get('/homa', [HomaController::class, 'index'])->name('homa');
...
Route::middleware(['auth', 'user_type:admin'])->group(function(){
        ...
        Route::get('/usuarios/{id}/delete-confirm', [UsuariosController::class, 'delete_confirm'])->name('usuarios.delete-confirm');
